...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center">Coca Cola 3D Model</h1>
        <div class="row">
                ...
                <div class="x3d-container">
                    <x3d width='500px' height='400px'>
                        <scene>
                            ...
                            <!-- 嵌入X3D模型 -->
                            <inline url='models/coke.x3d'></inline>
                        </scene>
                    </x3d>
                </div>
            </div>
        ...
        <p class="text-center my-4">
            Here you can explore the 3D model of Coca Cola. Use the buttons below to interact with the model.
        </p>
